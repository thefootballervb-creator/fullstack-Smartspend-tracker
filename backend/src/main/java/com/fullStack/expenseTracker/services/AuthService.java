...
public interface AuthService {
    ResponseEntity<?> save(SignUpRequestDto signUpRequestDto) throws UserAlreadyExistsException, UserServiceLogicException;
    ...
    ResponseEntity<?> verifyRegistrationVerification(String code) throws UserVerificationFailedException;
